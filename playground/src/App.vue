...
// Use `replace` so edits in the demos do not add a history entry on every write.
...
watchEffect(() => {
  ...
  // The pre-paint background in index.html must follow the active theme or short
  // pages expose the previous color.
