...
import { emitDebug } from './debug/bus'
 ...
 * @internal
 */
export function createQueryPipeline(channel: DebugChannelHandle): QueryPipelineBus {
  ...
  function tap<Stage extends QueryPipelineStage>(
    ...
    emitDebug(channel, 'pipeline:tap', { stages: [...stages], enforce: entry.enforce })
